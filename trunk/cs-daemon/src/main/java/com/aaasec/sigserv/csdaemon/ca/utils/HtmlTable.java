 ...
 *   under the Licence.
 */
package com.aaasec.sigserv.csdaemon.ca.utils;

import com.aaasec.sigserv.csdaemon.html.TableCellElement;
import com.aaasec.sigserv.csdaemon.html.TableElement;
import com.aaasec.sigserv.csdaemon.html.TableRowElement;


/**
 * HTML table element object
 */
public class HtmlTable extends TableElement {
    ...
    public enum Type {
        ...
        CERT(new CellStyle[]{CellStyle.TIME, CellStyle.SERIAL, CellStyle.NAME, CellStyle.EVENT, CellStyle.TIME}),
        ...
        CERTHEADING(new CellStyle[]{CellStyle.NORLMAL, CellStyle.NORLMAL, CellStyle.NORLMAL, CellStyle.NORLMAL, CellStyle.NORLMAL}),
