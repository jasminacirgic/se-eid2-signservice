 ...
 *   under the Licence.
 */
package com.aaasec.sigserv.csspserver.iaik;

import com.aaasec.sigserv.cscommon.Base64Coder;
import com.aaasec.sigserv.cscommon.data.SamlAssertionInfo;
 ...
 */
public class AuthContextQCStatementOld extends QCStatementInfo {

    /**
     * The statement id for this private QC statement.
     */
    public static final ObjectID statementID = new ObjectID("1.2.752.59.54138.2.1", "AuthContextQCStatement");
    public static final ObjectID contentID = new ObjectID("1.2.752.59.54138.2.1.1", "eID2SAMLContext");
    ...
    public AuthContextQCStatementOld() {
    }
     ...
     */
    public AuthContextQCStatementOld(SamlAssertionInfo statementInfo) {
