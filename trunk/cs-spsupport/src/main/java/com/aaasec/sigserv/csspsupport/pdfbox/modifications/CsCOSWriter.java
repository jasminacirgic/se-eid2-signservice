 ...
 */
package com.aaasec.sigserv.csspsupport.pdfbox.modifications;
 ...
 *
 * todo no support for incremental updates todo single xref section only todo no
 * linearization
 *
 ...
 */
public class CsCOSWriter implements ICOSVisitor {
     ...
     */
    public CsCOSWriter(OutputStream os) {
        super();
        setOutput(os);
     ...
     */
    public CsCOSWriter(OutputStream os, FileInputStream is) {
        this(os);
        in = is;
    ...
    /**
     * THIS IS THE ACTUAL MODIFICATION FOR CENTRAL SIGNING. THE ABILITY TO
     * CONTROL THE ID GENERATION TIME MAKES IT POSSIBLE TO ITERATE SIGNATURE
     * GENERATION TWO TIMES RESULTING IN THE SAME MESSAGE HASH FIRST ITERATION
     * IS TO EXTRACT THE SIGNEDATTRS. SECOND ITERATION IS TO ADD SIGNATURE WITH
